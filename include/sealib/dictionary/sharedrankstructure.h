...
class SharedRankStructure {
 protected:
    ...
    std::shared_ptr<const Sealib::BlockBitset> bitset;
 ...
 public:
     ...
     */
    explicit SharedRankStructure(std::shared_ptr<const Sealib::BlockBitset > bitset);
     ...
     */
    const Sealib::BlockBitset& getBitset() const;
