...
TEST(GraphTest, graph_integrity) {
     ...
     *      **********************************
     */
    adj_mtrx[0] = new uint[order]{0, 2, 0, 1};
    adj_mtrx[1] = new uint[order]{2, 0, 1, 0};
    adj_mtrx[2] = new uint[order]{0, 1, 0, 1};
    adj_mtrx[3] = new uint[order]{1, 0, 1, 0};
