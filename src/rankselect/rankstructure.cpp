...
uint Sealib::RankStructure::getSegmentCount() const {
    return segmentCount;
}
...
uint Sealib::RankStructure::getMaxRank() const {
    return maxRank;
}
const std::vector<uint> &Sealib::RankStructure::getSetCountTable() const {
